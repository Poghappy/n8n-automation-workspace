                ...
                if(data && data.state == 100){
                    ...
                    if($("#id").val() == ""){
                        $.dialog({
        					...
        					ok: function(){
                                try{
        							$("body",parent.document).find("#nav-waimaiQuanphp").click();
        							parent.reloadPage($("body",parent.document).find("#body-waimaiQuanphp"));
        							$("body",parent.document).find("#nav-waimaiQuanAdd s").click();
        						}catch(e){
        							location.href = thisPath + "waimaiQuan.php";
        						}
        					},
        					cancel: false
        				});
                        ...
                        $.dialog({
        					...
        					ok: function(){
                                try{
        							$("body",parent.document).find("#nav-waimaiQuanphp").click();
        							parent.reloadPage($("body",parent.document).find("#body-waimaiQuanphp"));
        							$("body",parent.document).find("#nav-waimaiQuanEdit"+$("#id").val()+" s").click();
        						}catch(e){
        							location.href = thisPath + "waimaiQuan.php";
        						}
        					},
