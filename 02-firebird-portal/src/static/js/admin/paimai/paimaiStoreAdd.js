...
$(function(){
	...
	$("#company").bind("input", function(){
		...
		if(val != ""){
			...
			huoniao.operaJson("paimaiStoreAdd.php?action=checkUser", "key="+val+"&id="+id, function(data){
  ...
  $("#editform input").keyup(function (e) {
	...
	$("#btnSubmit").bind("click", function(event){
		...
		//异步提交
		huoniao.operaJson("paimaiStoreAdd.php", $("#editform").serialize() + "&submit="+encodeURI("提交"), function(data){
			if(data.state == 100){
				if($("#dopost").val() == "save"){
