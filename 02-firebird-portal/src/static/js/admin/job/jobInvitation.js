...
function getList(){
	...
	huoniao.operaJson("jobInvitation.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < jobPost.length; i++){
				...
				list.push('  <td class="row20 left"><a class="userinfo" href="javascript:;" data-id="'+jobPost[i].userid+'">'+jobPost[i].nickname+'</a><br/>'+jobPost[i].date+'</td>');
				list.push('<td class="row10 ">'+jobPost[i].state+'</td></tr>');
			}
