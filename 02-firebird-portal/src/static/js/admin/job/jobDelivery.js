...
function getList(){
	...
	huoniao.operaJson("jobDelivery.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < jobPost.length; i++){
				...
				list.push('  <td class="row20 left"><a class="link" href="'+jobPost[i].resumeUrl+'" target="_blank">'+jobPost[i].resumeName+"</a><br>"+jobPost[i].resumePhone+'</td>');
				list.push('  <td class="row30 left"><a href="'+jobPost[i].postUrl+'" class="link" target="_blank">'+jobPost[i].title+'</a><br>'+jobPost[i].typename+'（'+jobPost[i].show_salary+'）</td>');
				list.push('  <td class="row20 left"><a class="link" target="_blank" href="'+jobPost[i].companyUrl+'">'+jobPost[i].ctitle+'</a><br>'+jobPost[i].contact+'</td>');
				list.push('  <td class="row20 left"><a class="userinfo link" href="javascript:;" data-id="'+jobPost[i].userid+'">'+jobPost[i].nickname+'</a><br/>'+jobPost[i].date+'</td>');

				list.push('<td class="row20 ">'+jobPost[i].state+'</td></tr>');
			}
