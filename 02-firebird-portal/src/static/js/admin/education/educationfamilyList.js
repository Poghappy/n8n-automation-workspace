	...
	huoniao.operaJson("educationfamilyList.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < educationfamilyList.length; i++){
				...
				list.push('  <td class="row10 left"><a href="'+educationfamilyList[i].url+'" target="_blank">'+educationfamilyList[i].tutoiname+sex+'</a>&nbsp;&nbsp;<a href="'+educationfamilyList[i].url+'" target="_blank"><i class="icon-share" style="margin-top:4px;"></i></a></td>');
