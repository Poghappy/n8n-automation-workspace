	...
	huoniao.operaJson("homemakingList.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < homemakingList.length; i++){
				...
				list.push('  <td class="row20 left"><a href="'+homemakingList[i].url+'" target="_blank">'+homemakingList[i].title+'</a><br><small>'+homemakingList[i].addrname+'</small></td>');
				list.push('  <td class="row17 left"><span><a href="'+homemakingList[i].storeUrl+'" target="_blank">'+homemakingList[i].store+'</a></span><br><small>'+homemakingList[i].storeaddrname+'</small></td>');
				list.push('  <td class="row10 left">'+homemakingList[i].typeidname+'</td>');
				list.push('  <td class="row8 left">'+homemakingList[i].price+'/'+homemakingList[i].sale+'</td>');
				list.push('  <td class="row12 left">'+homemakingList[i].username+'<br />'+homemakingList[i].contact+'</td>');
				var state = "";
