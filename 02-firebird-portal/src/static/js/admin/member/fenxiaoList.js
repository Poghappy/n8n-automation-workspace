$(function(){
    ...
    $("#export").click(function(e){
        ...
        var url = '?do=export&sKeyword='+sKeyword+'&start='+start+'&end='+end+'&type='+type+'&fenxiaouid='+fenxiaouid;
        console.log(url);
...
function getList(){
    ...
    var data = [];
    data.push("fenxiaouid="+fenxiaouid);
    ...
    huoniao.operaJson("fenxiaoList.php?dopost=getList",data.join("&"), function(val){
        console.log(val);
        ...
        $("#totalFee").html(val.pageInfo.totalFee);
        $("#todayFee").html(val.pageInfo.todayFee);
        ...
        if(val.state == "100"){
            ...
            for(i; i < list.length; i++){
                ...
                listArr.push('  <td class="row10 left">'+list[i].cityidname+'</td>');
                listArr.push('  <td class="row10 left">'+list[i].modulename+'</td>');
                listArr.push('  <td class="row13 left"><a href="javascript:;" class="userinfo" data-id="'+list[i].userid+'">'+list[i].unickname+'</a></td>');
                listArr.push('  <td class="row10 left">'+list[i].levelname+'</td>');
                listArr.push('  <td class="row6 left">'+list[i].amount+'</td>');
                listArr.push('  <td class="row6 left">'+list[i].fee+'</td>');
                listArr.push('  <td class="row30 left">'+list[i].ordernum+'</td>');
                listArr.push('  <td class="row12 left">'+list[i].pubdate+'</td>');
