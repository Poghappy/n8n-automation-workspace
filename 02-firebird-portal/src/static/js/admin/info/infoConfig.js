$(function(){
	...
	$(".addPrice").bind("click", function(){
		var html='              <tr>\n' +
			...
			'                    <input class="span1 day" id="info_refreshday" name="info_refresh[day][]" value="" type="number">\n' +
			'                    <input class="dayText" name="info_refresh[daytext][]" value="2" type="hidden">\n' +
