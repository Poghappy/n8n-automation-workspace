        ...
        function (t, e, n) {
            ...
            function d(t) {
                return (function t(e) {
                    ...
                    r && (n[r] = e);
                    for (
                        var i = Array.from(e.children), a = o ? (n[o] = {}) : n, c = 0; c < i.length; c++
                    ) {
                        var s = i[c],
                            u = p(s, "data-arr");
            ...
            function f(t) {
                ...
                function o(o) {
                    for (
                        var r = t.value, i = t.selectionStart, a = i, c = "", s = i - 1; s > 0 && n(r[s]); s--
                    )
                        (c = r[s] + c), a--;
            ...
            function v(t, e) {
                return (
                    ...
                    (function (t, e) {
                        ...
                        try {
                            for (
                                var a, c = t[Symbol.iterator](); !(o = (a = c.next()).done) &&
                                (n.push(a.value), !e || n.length !== e); o = !0
                            );
                        } catch (t) {
                            (r = !0), (i = t);
                        } finally {
                    ...
                    if ((e = n[r].exec(t)))
                        switch (r) {
                            case "cmyk":
                                ...
                                return {
                                    values: y(C(a, c, s, u)).concat([1]), type: r
                                };
                            case "rgba":
                                var l = v(o(e), 6),
                                    p = l[2],
                                ...
                                return {
                                    values: y(A(p, d, h)).concat([g]), type: r
                                };
                            case "hex":
                                var m = function (t, e) {
                            ...
                            case "hsla":
                                ...
                                return {
                                    values: y(S(x, E, H)).concat([B]), type: r
                                };
                            case "hsva":
                                var P = v(o(e), 6),
                                    L = P[2],
            ...
            function E(t) {
                var e = {
                    ...
                    _tapmove: function (t) {
                        ...
                        if (t) {
                            ...
                            a < i.left ?
                                (a = i.left) :
                                a > i.left + i.width && (a = i.left + i.width),
                                c < i.top ?
                                (c = i.top) :
                                c > i.top + i.height && (c = i.top + i.height),
                                (a -= i.left),
                                (c -= i.top);
                        } else o && ((a = o.x), (c = o.y));
                ...
                var n = e.options,
                    o = e._tapstart;
                return (
                    c([n.wrapper, n.element], "mousedown", o),
                    ...
                    (function (t, e, n) {
                                    ...
                                    (this._root = (function (t) {
                                        var e = t.components,
                                            ...
                                            i = d(
                                                ...
                                                .concat(
                                                    r(Object.keys(e.interaction).length),
                                                ...
                                                .concat(
                                                    ...
                                                    '>\n                    <input data-key="reset" class="pcr-clear pcr-reset" value="' 
                                                )
                                                .concat(e.interaction.reset, '" type="button" ')
                                                .concat(
                                                    r(e.interaction.reset),
                                                    '>\n                   <div class="upload_btn"'
                                                )
                                                .concat( r(e.interaction.upload),)
                                                .concat(' >\n    <input data-key="upload" value="" type="file" name="Filedata" id="'+ e.interaction.upload_name +'_filedata"  data-type="'+ e.interaction.upload_name +'" accept="png,jpg,jpeg" class="fileUp" ><span>'+e.interaction.upload+'</span></div>')
                                    ...
                                    n = {
                                            ...
                                            onchange: function (e, n) {
                                                ...
                                                i.comparison ||
                                                    ((r.button.style.background = a),
                                                        i.useAsButton ||
                                                        (r.preview.lastColor.style.background = a)),
                                        ...
                                        opacity: E({
                                            ...
                                            onchange: function (n, o) {
                                                e.opacity &&
                                                    ((t._color.a =
                                                            Math.round((o / this.wrapper.offsetHeight) * 100) /
                                                            100),
                                                        (this.element.style.background =
                                                            "rgba(0, 0, 0, ".concat(t._color.a, ")")),
                                ...
                                if (!n.showAlways) {
                                    ...
                                    o.push(
                                            c(document, "keyup", function (e) {
                                                return (
                                                    t.isOpen() && (e.key === r || e.code === r) && t.hide()
                                                );
                                            })
                                        ),
                                        o.push(
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                "middle" !== this.options.position &&
                                    ((u < 0 && -u < r.width / 2) ||
                                        (l > window.innerWidth &&
                                            l - window.innerWidth < r.width / 2)) ?
                                    (s = a.middle) :
                                    u < 0 ?
                                    (s = a.right) :
                                    l > window.innerWidth && (s = a.left),
                                    (i.left = "".concat(s, "px"));
                            }
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this._root.interaction.type() &&
                                    (this._root.interaction.result.value = (function () {
                                        var e =
                                            "to" +
                                            t._root.interaction.type().getAttribute("data-type");
                                        return "function" == typeof t._color[e] ?
                                            t._color[e]().toString() :
                                            "";
                                    })()),
                            ...
                            value: function (t) {
                                ...
                                if (o) {
                                    ...
                                    if (!c.hidden) {
                                        ...
                                        try {
                                            for (
                                                var p, d = a[Symbol.iterator](); !(s = (p = d.next()).done); s = !0
                                            ) {
                                                var h = p.value;
