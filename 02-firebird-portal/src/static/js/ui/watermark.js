(function (root, factory) {
    ...
    var defaultSettings = {
        ...
        watermark_font: 'PingFang SC,microsoft yahei',           //水印字体
    ...
    var loadMark = function (settings) {
        ...
        for (var i = 0; i < defaultSettings.watermark_rows; i++) {
            ...
            for (var j = 0; j < defaultSettings.watermark_cols; j++) {
                ...
                mask_div.innerHTML = defaultSettings.watermark_txt + '<br /><small>' + ymd + '</small>';
                /*设置水印相关属性start*/
                ...
                mask_div.style.lineHeight = "1.2em";
