    ...
    var map, filterData, list = $(".list"), init = {
        ...
        , tilesloaded: function () {
            ...
            $(".map-os").bind("click", function () {
                ...
                t.hasClass("open") ? (sidebar.stop().animate({ "left": 0 }, 150), t.attr("title", "收起左栏"), t.removeClass("open"), $("#" + g_conf.mapWrapper).animate({ "left": "360px" }, 150)) : (sidebar.stop().animate({ "left": "-360px" }, 150), t.attr("title", "展开左栏"), t.addClass("open"), $("#" + g_conf.mapWrapper).animate({ "left": "0" }, 150));
            });
        ...
        , storeClick: function (e) {
            var tar = e.target.Ow;
            var url = $(tar).find('.bubble').attr('data-url');
            window.open(url)
        }
