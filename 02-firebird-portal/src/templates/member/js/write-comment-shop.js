$(function(){
  ...
  $(".pjbox .widgt i").hover(function(){
    var t = $(this);
    t.closest('.widgt').find('i').removeClass('hover').removeClass('nhover');
    t.addClass('hover')
    t.prevAll('i').addClass('hover');
    t.nextAll('i').addClass('nhover')
  },function(){
    var t = $(this);
    // t.closest('.widgt').find('i').removeClass('hover').removeClass('nhover')
  })

  $(".pjbox .widgt").hover(function(){

  },function(){
    $(this).find('i').removeClass('hover').removeClass('nhover')
  })

  $(".pjbox .widgt i").click(function(){
    var t = $(this);
    t.closest('.widgt').find('i').removeClass('hover').removeClass('on').removeClass('nhover');
    t.addClass('on')
    t.prevAll('i').addClass('on');
    t.closest('.fn-left').find('input').val(t.index() + 1)
  })

  $(".ratebox").click(function(){
    $(this).find('.icon_comm ').addClass('on');
    $(this).siblings('.ratebox').find('.icon_comm').removeClass('on');
  })
