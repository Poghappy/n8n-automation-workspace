...
$(function(){
        ...
        gzAddrInit = {
            ...
            showChooseAddr: function(){
                var postop  = gzAddrSeladdrCurr.offset().top + gzAddrSeladdrCurr.outerHeight(),
    ...
    gzSelAddrList.delegate("a", "click", function(){
        ...
        if(id && addr){//
            ...
            gzAddrSeladdrCurr.removeClass("gz-no-sel").attr("data-ids", ids.join(" ")).attr("data-id", id);
            gzAddrSeladdrCurr.find('#cityName').val(addrname);
