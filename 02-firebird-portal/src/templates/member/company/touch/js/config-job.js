$(function () {
    ...
    var gzAddress = $(".gz-address"),  //选择地址页
        ...
        gzAddrInit = {
            ...
            , getAddrArea: function (id) {
                ...
                $.ajax({
                    url: masterDomain + "/include/ajax.php?service=job&action=addr&store=1",
                    data: "type=" + id,
                    type: "GET",
                    dataType: "jsonp",
                    success: function (data) {
            ...
            , QuanList: function () {
                ...
                if (!id) return;
                $.ajax({
                    url: masterDomain + "/include/ajax.php?service=job&action=circle&type=" + id,
                    type: "GET",
                    dataType: "jsonp",
                    success: function (data) {
                        if (data && data.state == 100) {
    ...
    $(".LoTitle span").bind("click", function () {
        // 2023.12.21修改
        let formData = {
            '#nature_dummy_val': $('#nature_dummy').val(),
            '#scale_dummy_val': $('#scale_dummy').val(),
            '#industry_dummy_val': $('#industry_dummy').val(),
            ...
            '#email_val': $('#email').val(),
            '#postcode_val': $('#postcode').val(),
            '#site_val': $('#site').val(),
            '#body_val': $('#body').val(),
            '.p-tags_html': $('.p-tags').html()
        }
