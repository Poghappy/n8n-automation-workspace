...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require('/include/pdf/pdf.js');
}
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/include/pdf/images/';
  PDFJS.workerSrc = '/include/pdf/pdf.worker.js';
  PDFJS.cMapUrl = '/include/pdf/cmaps/';
