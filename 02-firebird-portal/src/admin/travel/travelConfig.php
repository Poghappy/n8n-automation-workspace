...
if ($type != "") {
    ...
    $customInc .= "\$customtravelhotelTag = '" . $customtravelhotelTag . "';\r\n";
...
if (file_exists($tpl . "/" . $templates)) {
    ...
    //酒店特色便签
     $huoniaoTag->assign('travelhotelTag',$customtravelhotelTag);
