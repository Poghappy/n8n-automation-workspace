...
checkPurview("awardlegouType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/awardlegou";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "awardlegouType.html";

$action = "awardlegou_type";
...
//删除分类
	...
	foreach ($idsArr as $kk => $id) {
		...
		if($res){
			delPicFile($res[0]['litpic'], "delAdv", "awardlegou");
		}
	}
...
if(file_exists($tpl."/".$templates)){
	...
	$jsFile = array(
		...
		'admin/awardlegou/awardlegouType.js'
	);
