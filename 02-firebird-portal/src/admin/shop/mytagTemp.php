...
//新增标记
	...
	if($submit == "提交"){
		...
		$archives = $dsql->SetQuery("INSERT INTO `#@__mytag_temp` (`title`, `module`, `type`, `litpic`, `css`, `isSystem`, `state`, `pubdate`) VALUES ('$title', '$action', 'slist', '$litpic', '$css', '$isSystem', '$state', '".GetMkTime(time())."')");
