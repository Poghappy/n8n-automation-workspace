 ...
 * 圈子频道配置
 *
 * @version        $Id: circleConfig.php 2019-10-22 上午12:00:18 $
...
$templates = "circleConfig.html";

if ($action == "") {
    $action = "circle";
}

checkPurview("circleConfig");
...
if ($type != "") {
    ...
    $customInc .= "\$customhot = " . (int)$customhot . ";\r\n";
...
if (file_exists($tpl . "/" . $templates)) {
    ...
    $huoniaoTag->assign('hot', $customhot);
