var sortBy = function(prop){
    ...
    var gzAddress         = $(".gz-address"),  //选择地址页
        ...
        gzAddrInit = {
            ...
            ,getAddrArea: function(id){
                ...
                $.ajax({
                    url: "/include/ajax.php?service="+(window.modelType ? window.modelType : 'siteConfig')+"&action="+gzAction,
                    data: "type="+id+param,
                    type: "GET",
                    dataType: "jsonp",
    ...
    gzAddrSeladdr.bind("click", function(){
        ...
        var t = $(this), ids = t.attr("data-ids"), id = t.attr("data-id"), addrname = $("#cityName").text();
