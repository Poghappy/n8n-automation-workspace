...
checkPurview("paimaiConfig");
$dsql = new dsql($dbo);

$tpl = dirname(__FILE__) . "/../templates/paimai";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "paimaiConfig.html";

$action = $action == "" ? "paimai" : $action;
...
/*        $sql = $dsql->SetQuery("UPDATE `#@__paimai_city` SET `type` = 2 WHERE `type` = 1");
