 ...
 * 养老机构配置
 *
 * @version        $Id: pensionConfig.php 2019-07-29 上午10:12:36 $
...
checkPurview("pensionConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__) . "/../templates/pension";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "pensionConfig.html";

$action = $action == "" ? "pension" : $action;
...
if ($type != "") {
    ...
    if ($type == "site") {
        ...
        $custompensionoldCheck = (int)$pensionoldCheck;
    ...
    $customInc .= "\$custompensionoldCheck = '" . $custompensionoldCheck . "';\r\n";
...
if (file_exists($tpl . "/" . $templates)) {
    ...
    $jsFile = array(
        ...
        'publicUpload.js',
        'admin/pension/pensionConfig.js'
    );
    ...
    $huoniaoTag->assign('pensionoldCheckNum', array('0', '1'));
    $huoniaoTag->assign('pensionoldCheckNames', array('需要审核', '不需要审核'));
    $huoniaoTag->assign('pensionoldCheckChecked', (int)$custompensionoldCheck);
