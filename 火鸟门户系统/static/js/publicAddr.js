...
$(function(){
        ...
        gzAddrInit = {
                          ...
                          if (getAddrFirst == 0) {
                            if (gzAddrAction == "area") {
                              ...
                              if(list.length > 30){
                                ...
                                szmArr = Object.keys(cityArr);

                                szmArr.sort();
                                var list = [], topSzm = [];
                                for(var i = 0; i < szmArr.length; i++){
                                	if(szmArr[i] == "in_array" || szmArr[i] == 'uniquelize') continue;
            ...
            ,gzAddrReset: function(i, ids, addrArr){
                ...
                addrname = addrname == undefined || addrname == '' ? '请选择' : addrname;
                        ...
                        if (first == 0) {
                          if (gzAddrAction == 'area') {
                            ...
                            if(list.length > 30){
                              ...
                              var szmArr =Object.keys(cityArr);
    ...
    gzAddrSeladdr.on("click", function(){
        ...
        //第一次点击
        if((ids == undefined || ids == "") && (id == "0" || id == undefined)){
          getAddrFirst = 0;
