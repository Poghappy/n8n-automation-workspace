        ...
        var e = s,
            ...
            function(g) {
                ...
                function q(a) {
                    return {
                        value: a,
                        display: (ba.match(/yy/i) ? a : (a + "").substr(2, 2)) + (A.yearSuffix || "")+A.yearText
                    }
                }
                ...
                if (t.match(/date/i)) {
                    ...
                    for (p = 0; 3 > p; p++)
                        ...
                        for (i = 0; 12 > i; i++) O = ba.replace(/[dy]/gi, "").replace(/mm/, (9 > i ? "0" + (i + 1) : i + 1) + (A.monthSuffix || "")).replace(/m/, i + 1 + (A.monthSuffix || "")), w.push({
                            value: i,
                            display: O.match(/MM/) ? O.replace(/MM/, '<span class="mbsc-dt-month">' + A.monthNames[i] + A.monthText + "</span>") : O.replace(/M/, '<span class="mbsc-dt-month">' + A.monthNamesShort[i] + "</span>")
                        });
                        ...
                        for (i = 1; 32 > i; i++) w.push({
                            value: i,
                            display: (ba.match(/dd/i) && 10 > i ? "0" + i : i) + (A.daySuffix || "")+A.dayText
                        });
                    ...
                    for (p = M; p < M + 4; p++)
                        if (p == y.h) {
                            ...
                            for (i = Fa; i < (ca ? 12 : 24); i += aa) w.push({
                                value: i,
                                display: (ca && 0 === i ? 12 : V.match(/hh/i) && 10 > i ? "0" + i : i)+A.hourText
                            });
                        ...
                        for (i = va; 60 > i; i += r) w.push({
                            value: i,
                            display: (V.match(/ii/) && 10 > i ? "0" + i : i)+A.minuteText,
                        });
                ...
                return {
                    ...
                    validate: function(a) {
                        ...
                        if (p && (p._length !== q || N && (d === h || d === y.y || d === y.m))) {
                            a[y.d] = p;
                            p.data = [];
                            for (d = 1; d <= q; d++) i = A.getDate(n, w, d).getDay(), f = ba.replace(/[my]/gi, "").replace(/dd/, (10 > d ? "0" + d : d) + (A.daySuffix || "")+A.dayText).replace(/d/, d + (A.daySuffix || "")+A.dayText), p.data.push({
                                value: d,
                                display: f.match(/DD/) ? f.replace(/DD/, '<span class="mbsc-dt-day">' + A.dayNames[i] +A.dayText+ "</span>") : f.replace(/D/, '<span class="mbsc-dt-day">' + A.dayNamesShort[i] +A.dayText+ "</span>")
                            });
