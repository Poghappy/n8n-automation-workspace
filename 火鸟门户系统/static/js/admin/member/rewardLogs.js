...
function getList(){
    ...
    huoniao.operaJson("rewardLogs.php?dopost=getList", data.join("&"), function(val){
        ...
        if(val.state == "100"){
            ...
            for(i; i < list.length; i++){
                ...
                listArr.push('  <td class="row8 left">'+list[i].addrname+'</td>');
                listArr.push('  <td class="row10 left">'+list[i].module+'</td>');
                var type = list[i].type==0?"打赏":"礼物";
                listArr.push('  <td class="row7 left">'+type+'</td>');
                var user_info = list[i].reward_userid>0 ? 'href="javascript:;" data-id="'+list[i].reward_userid+'" class="userinfo"' : 'data-id="'+list[i].reward_userid+'"';
                ...
                if(list[i].url){
                    ...
                    var hasTitle = list[i].title!=""? list[i].title: "未知";
                    listArr.push('  <td class="row25 left">'+hasTitle+'</td>');
                }

                var amount = list[i].amount;
                listArr.push('  <td class="row10 left">'+amount+'</td>');
                var to_user_info = list[i].touid>0 ? 'href="javascript:;" data-id="'+list[i].touid+'" class="userinfo"' : 'data-id="'+list[i].touid+'"';
                listArr.push('  <td class="row10 left"><a '+to_user_info+'>'+list[i].touser+'</a></td>');
