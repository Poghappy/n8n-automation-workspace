    ...
    huoniao.operaJson("?dopost=getList", data.join("&"), function(val){
        ...
        if(val.state == "100"){
            ...
            for(i; i < list.length; i++){
                ...
                listArr.push('  <td class="row10 left">'+list[i].ordernum+'</td>');
                listArr.push('  <td class="row20 left"><a class="userinfo" href="javascript:void(0);" data-id="'+list[i].uid+'">'+list[i].nickname+'</a></td>');

                listArr.push('  <td class="row20 left">'+list[i].title+'</td>');

                listArr.push('  <td class="row10 left">'+list[i].amount+'</td>');
                listArr.push('  <td class="row20 left">'+list[i].pubdate+'</td>');
            }
