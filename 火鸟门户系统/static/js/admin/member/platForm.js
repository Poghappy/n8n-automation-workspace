$(function(){
  ...
  $("#keyword").keyup(function (e) {
	...
	//二级菜单点击事件
	$("#stateBtn, #pageBtn, #paginationBtn,#leimuBtn,#moduleBtn").delegate("a", "click", function(){
...
function getList(){
	...
	var sKeyword = encodeURIComponent($("#sKeyword").html()),
		...
		type     = $("#stateBtn").attr("data-id") ? $("#stateBtn").attr("data-id") : "",
		leimutype    = $("#leimuBtn").attr("data-id") ? $("#leimuBtn").attr("data-id") : "",
		module     = $("#moduleBtn").attr("data-id") ? $("#moduleBtn").attr("data-id") : "",
	...
	huoniao.operaJson("platForm.php?dopost=getList", data.join("&"), function(val){
		...
		$(".totalMoney").html(val.totalLess);
        $("#totalAdd").html(val.totalAdd);
		$("#totalLess").html(val.totalLess);
		$("#totalCharge").html(val.totalCharge);
