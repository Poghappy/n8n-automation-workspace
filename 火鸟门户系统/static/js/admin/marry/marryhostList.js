	...
	huoniao.operaJson("marryhostList.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < hostList.length; i++){
				...
				list.push('  <td class="row25 left"><a href="javascript:;" >'+hostList[i].hostname+'</a>&nbsp;&nbsp;<a href="'+hostList[i].url+'" target="_blank"><i class="icon-share" style="margin-top:4px;"></i></a></td>');
