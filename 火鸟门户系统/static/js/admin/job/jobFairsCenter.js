	...
	huoniao.operaJson("jobFairsCenter.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < jobFairsCenter.length; i++){
				...
				list.push('  <td class="row25 left">'+jobFairsCenter[i].title+'</td>');
				...
				list.push('  <td class="row14 left"><a href="javascript:;" data-id="'+jobFairsCenter[i].addrid+'" class="addr">'+jobFairsCenter[i].addr+'</a></td>');
