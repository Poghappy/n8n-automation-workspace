	...
	huoniao.operaJson("educationcoursesList.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < coursesList.length; i++){
				...
				list.push('  <td class="row20 left"><a href="'+coursesList[i].url+'" target="_blank">'+coursesList[i].coursesname+'</a>&nbsp;&nbsp;<a href="'+coursesList[i].url+'" target="_blank"><i class="icon-share" style="margin-top:4px;"></i></a></td>');
