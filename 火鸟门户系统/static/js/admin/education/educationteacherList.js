	...
	huoniao.operaJson("educationteacherList.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < educationteacherList.length; i++){
				...
				list.push('  <td class="row15 left"><a href="'+educationteacherList[i].url+'" target="_blank">'+educationteacherList[i].username+'</a>&nbsp;&nbsp;<a href="'+educationteacherList[i].url+'" target="_blank"><i class="icon-share" style="margin-top:4px;"></i></a></td>');
