...
defaultModel = {
    ...
    memberComp: {
        ...
        "business": {
            ...
            "link": businessUrl + '?appFullScreen&appIndex=1&currentPageOpen=1',
            "mini":'/pages/packages/company/index/index',
            "text": "商家版"
        },
        "branch": {
            "icon": masterDomain + "/static/images/admin/siteMemberPage/icon01.png",
...
var allModels = [
    // 模板1
    {
        "memberComp": {
            ...
            "style": {
                "bg_color": "#FFFFFF",
                "initBg_color": "#FFFFFF",
                "bg_image": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/bg_04.png",
                "bgID": 4
            },
            "business": {
                "icon": masterDomain + "/static/images/admin/siteMemberPage/icon01.png",
            ...
            "headLink":memberDomain + "/profile.html", //头像链接
            "headLinkInfo":{
                "linkText":"个人资料",
                "selfSetTel":0,
            },
            "branchShow":true, //是否显示工作台
            "branch": {
                "icon": masterDomain + "/static/images/admin/siteMemberPage/icon01.png",
                "link": memberDomain + "/workPlatform",
                "linkInfo":{
                    "linkText":"员工工作台",
                    "selfSetTel":0
                },
        ...
        "pageSet": {
            ...
            "layout": 0,
            "title": "",
            "infoData": ["point", "money", "quan", "collect", "qiandao"],
            "orderData": ["daifukuan", "daishouhuo"],
            "style": {
                "background": "#FFFFFF",
                "init_background": "#FFFFFF",
                "color": "#070F21",
            ...
            "btns": {
                ...
                "themeType": "light",
                "list": [{
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/shop_icon01.png",
                    "link": memberDomain + "/workPlatform",
                    "linkInfo":{
                        "linkText":"员工工作台",
                        "selfSetTel":0
        ...
        "compArrs": [{
            ...
            "content": {
                ...
                "orderOption": [{
                    "id": 1,
                    "text": "待付款",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/order_01.png?v=1",
                    ...
                    "id": 2,
                    "text": "待使用",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/order_02.png?v=1",
                    ...
                    "id": 3,
                    "text": "待发货",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/order_03.png?v=1",
                    ...
                    "id": 4,
                    "text": "待收货",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/order_04.png?v=1",
                    ...
                    "id": 5,
                    "text": "待评价",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/order_05.png?v=1",
                    ...
                    "id": 6,
                    "text": "待分享",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/order_06.png?v=1",
                    ...
                    "id": 7,
                    "text": "退款售后",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/order_07.png?v=1",
                    ...
                    "id": 8,
                    "text": "全部",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/order_08.png?v=1",
                    "link": memberDomain + "/orderlist.html",
                    "mini":"/pages/member/order/index",
                    "linkInfo":{
                        "linkText":"个人订单(全部)",
            ...
            "content": {
                ...
                "btns": {
                    "list": [{
                        ...
                        "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/icons_10.png",
                        "text": "浏览记录",
                        "link": memberDomain + "/history",
                        "linkInfo":{
                            "linkText":"浏览记录",
                            "selfSetTel":0
                        }
     ...
     // 模板2
    {
        "memberComp": {
            ...
            "style": {
                "bg_color": "#FFFFFF",
                "initBg_color": "#FFFFFF",
                "bg_image": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/bg_07.png",
                "bgID": 7
            },
            "business": {
                "icon": masterDomain + "/static/images/admin/siteMemberPage/icon01.png",
            ...
            "vipCard": {
                ...
                "style": {
                    "bgType": "color",
                    "background": "linear-gradient(90deg,#302E2F 0%, #302E2F 100%)",
                    "backimg": "",
                    "initBackground": "linear-gradient(90deg, #302E2F 0%, #302E2F 100%)"
                },
                "btnLink": memberDomain + '/upgrade.html',
                "btnLinkInfo":{
                    "linkText":"VIP中心",
        ...
        "pageSet": {
            ...
            "layout": 0,
            "title": "",
            "infoData": ["collect", "footPrint", "fabu", "follow", "point", "money", "quan", "bonus", "qiandao"],
            "orderData": ["daifukuan", "daifahuo", "daishouhuo"],
            "style": {
                "background": "#FFFFFF",
                "init_background": "#FFFFFF",
                "color": "#070F21",
        ...
        "compArrs": [{
            ...
            "content": {
                ...
                "list": [{
                    "text": "邀请有礼",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/list_icon01.png",
                    "link": memberDomain + "/invite.html",
                    "linkInfo":{
                        "linkText":"邀新有礼",
                        "selfSetTel":0
                    ...
                    "text": "合伙人计划",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/list_icon02.png",
                    "link": memberDomain + "/fenxiao.html",
                    "linkInfo":{
                        "linkText":"分销",
                        "selfSetTel":0
                    ...
                    "text": "收货地址",
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/list_icon03.png",
                    "link": memberDomain + "/address.html",
                    "linkInfo":{
                        "linkText":"收货地址管理",
                        "selfSetTel":0
                    ...
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/list_icon04.png",
                    "link": memberDomain + '/enter.html#join',
                    "linkInfo":{
                        "linkText":"入驻商家",
                        "selfSetTel":0
                    },
     ...
     // 模板3
    {
        "memberComp": {
            ...
            "style": {
                "bg_color": "#FFFFFF",
                "initBg_color": "#FFFFFF",
                "bg_image": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/bg_05.png",
                "bgID": 5
            },
            "business": {
                "icon": masterDomain + "/static/images/admin/siteMemberPage/shop_icon.png",
                "link": businessUrl + '?appFullScreen&appIndex=1&currentPageOpen=1',
                "linkInfo":{
                    "linkText":"切换商家版",
                    "mini":'/pages/packages/company/index/index',
            ...
            "setBtns": {
                "btnType": 1,
                "btns": [{
                    "icon": masterDomain + "/static/images/admin/siteMemberPage/icon04.png",
                    "link": memberDomain + "/qiandao.html",
                    "linkInfo":{
                        "linkText":"签到",
                        "selfSetTel":0
            ...
            "vipBtnsGroup": [{
                ...
                "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/vipcard_01.png"
            }, {
                "text": "我的收藏",
                ...
                "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/vipcard_02.png"
            }, {
                "text": "浏览记录",
                ...
                "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/vipcard_03.png"
            }, {
                "text": "合伙人",
                "link": memberDomain + "/fenxiao.html",
                "linkInfo":{
                ...
                "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/vipcard_04.png"
            }],
            "numberCount": {
                "showItems": [1, 2, 3, 4],
                "numberStyle": {
        ...
        "pageSet": {
            ...
            "layout": 0,
            "title": "",
            "infoData": ["point", "money", "quan", "collect", "bonus", "qiandao","fans","follow","zan"],
            "orderData": ["daifukuan", "daixiaofei", "daifahuo"],
            "style": {
                "background": "#FFFFFF",
                "init_background": "#FFFFFF",
                "color": "#070F21",
        ...
        "compArrs": [{
            ...
            "content": {
                ...
                "style": {
                    ...
                    "bg_color": "#FFFFFF",
                    "initBg_color": "#FFFFFF",
                    "bg_image": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/finance.png"
                }
            }
        }, {
            "id": 2,
     ...
     // 模板4
    {
        "memberComp": {
            ...
            "headLink":memberDomain + "/profile.html",
            "headLinkInfo":{
                "linkText":"个人资料",
                "selfSetTel":0
            },
            ...
            "vipBtnsGroup": [{
                ...
                "icon": masterDomain + "/static/images/admin/siteMemberPage/defaultImg/vipcard_05.png"
            }, {
                "text": "合伙人",
                "link": memberDomain + "/fenxiao.html",
                "linkInfo":{
        ...
        "pageSet": {
            ...
            "layout": 0,
            "title": "",
            "infoData": ["point", "money", "quan", "collect", "qiandao","fans","follow","zan"],
            "orderData": ["daifukuan", "daixiaofei", "daifahuo"],
            "style": {
                "background": "#FFFFFF",
                "init_background": "#FFFFFF",
...
var linkListBox = [
	{
		...
		"list":[{
			...
			"link":memberDomain + "/orderlist.html?state=4",
            "mini":"/pages/member/order/index?state66",
			"linkText":"待收货"
		},{
			"link":memberDomain + "/orderlist.html?state=5",
            "mini":"/pages/member/order/index?state=5",
...
var page = new Vue({
    ...
    data:{
        ...
        showMemberTopStylePop:false, // 用户头部风格选择
        showholeModelStylePop:false, //官方模板
        ...
        numberOption:[
            ...
            {id:3,text:'优惠券',num:'36',code:'quan',link:memberDomain + '/myquan.html'},
            ...
            {id:7,text:'发布',num:'29',code:'fabu',link:memberDomain + '/manage.html',"mini":"/pages/packages/mcenter/fabu/fabu",},
        ...
        orderOption:[
            {id:1,text:'待付款',icon:defaultPath + 'order_01.png?v=1',link:memberDomain + '/orderlist.html?state=3',"mini":"/pages/member/order/index?state=1",btnText:'待付款',code:'daifukuan'},
            {id:2,text:'待使用',icon:defaultPath + 'order_02.png?v=1',link:memberDomain + '/orderlist.html?state=2',"mini":"/pages/member/order/index?state=2",btnText:'待使用',code:'daixiaofei'},
            {id:3,text:'待发货',icon:defaultPath + 'order_03.png?v=1',link:memberDomain + '/orderlist.html?state=3',"mini":"/pages/member/order/index?state=3",btnText:'待发货',code:'daifahuo'},
            {id:4,text:'待收货',icon:defaultPath + 'order_04.png?v=1',link:memberDomain + '/orderlist.html?state=4',"mini":"/pages/member/order/index?state=4",btnText:'待收货',code:'daishouhuo'},
            {id:5,text:'待评价',icon:defaultPath + 'order_05.png?v=1',link:memberDomain + '/orderlist.html?state=5',"mini":"/pages/member/order/index?state=5",btnText:'待评价',code:'daipingjia'},
            {id:6,text:'待分享',icon:defaultPath + 'order_06.png?v=1',link:memberDomain + '/orderlist.html?state=6',"mini":"/pages/member/order/index?state=6",btnText:'待分享',code:'daifenxiang'},
            {id:7,text:'退款售后',icon:defaultPath + 'order_07.png?v=1',link:memberDomain + '/orderlist.html?state=7',"mini":"/pages/member/order/index?state=7",btnText:'退款售后',code:'tuikuanshouhou'},
            {id:8,text:'全部',icon:defaultPath + 'order_08.png?v=1',link:memberDomain + '/orderlist.html',"mini":"/pages/member/order/index",btnText:'全部',code:'all'},
        ], //订单选项
        ...
        currFocus:'business', //当前聚焦 business => 商家版    branch => 工作台
        ...
        memberDefaultStyle:[
            // 风格1
            {
                ...
                style: {
                    ...
                    'bg_image': defaultPath + 'bg_04.png', //背景图
                    'bgID':4,
                },
                "headLink":memberDomain + "/profile.html", //头像链接
                "headLinkInfo":{
            ...
            {
                theme: 2, //选择的样式
                themeType: 'light', //dark => 深色模式  light => 反白模式
                bgType: 'image', //image => 背景图   color => 纯色背景
                style: {
                    'bg_color': '#FFFFFF', //背景色
                    'initBg_color': '#FFFFFF', //背景色
                    'bg_image': defaultPath + 'bg_07.png', //背景图
                    'bgID':7,
                },
                "headLink":memberDomain + "/profile.html", //头像链接
                "headLinkInfo":{
                ...
                vipCard: {
                    ...
                    style: {
                        bgType: 'color', //image => 背景图   color => 纯色背景
                        background: 'linear-gradient(90deg, #302E2F 0%, #302E2F 100%)', //背景色
                        backimg: '', //背景图
                        initBackground: 'linear-gradient(90deg, #302E2F 0%, #302E2F 100%)',
                    },
                    btnText: '开通会员',
                    btnStyle: {
                        styleType: 'arrow', //raduis => 圆角   arrow => 箭头
                        style: {
                            // arrColor: '#ff0000', //按钮箭头颜色
                            color: '#FFFFFF', //按钮文字颜色
                            initColor: '#FFFFFF',
                            background: '#F0DEBD', //按钮背景
                            initBackground: '#F0DEBD',
                            borderRadius: 26, //圆角
            ...
            // 风格三
            {
                ...
                style:{
                    'bg_color':'#FFFFFF', //背景色
                    'initBg_color':'#FFFFFF', //背景色
                    'bg_image':defaultPath + 'bg_05.png', //背景图
                    'bgID':5,
                },
                "headLink":memberDomain + "/profile.html", //头像链接
                "headLinkInfo":{
        ...
        orderFormData:{
            ...
            orderOption:[
                {id:1,text:'待付款',icon:defaultPath + 'order_01.png?v=1',link:memberDomain + '/orderlist.html?state=1',"mini":"/pages/member/order/index?state=1",linkInfo:{ "linkText":"待付款", "selfSetTel":0 },btnText:'待付款',code:'daifukuan'},
                {id:2,text:'待使用',icon:defaultPath + 'order_02.png?v=1',link:memberDomain + '/orderlist.html?state=2',"mini":"/pages/member/order/index?state=2",linkInfo:{ "linkText":"待使用", "selfSetTel":0 },btnText:'待使用',code:'daixiaofei'},
                {id:3,text:'待发货',icon:defaultPath + 'order_03.png?v=1',link:memberDomain + '/orderlist.html?state=3',"mini":"/pages/member/order/index?state=3",linkInfo:{ "linkText":"待发货", "selfSetTel":0 },btnText:'待发货',code:'daifahuo'},
                {id:4,text:'待收货',icon:defaultPath + 'order_04.png?v=1',link:memberDomain + '/orderlist.html?state=4',"mini":"/pages/member/order/index?state=4",linkInfo:{ "linkText":"待收货", "selfSetTel":0 },btnText:'待收货',code:'daishouhuo'},
                {id:5,text:'待评价',icon:defaultPath + 'order_05.png?v=1',link:memberDomain + '/orderlist.html?state=5',"mini":"/pages/member/order/index?state=5",linkInfo:{ "linkText":"待评价", "selfSetTel":0 },btnText:'待评价',code:'daipingjia'},
                {id:6,text:'待分享',icon:defaultPath + 'order_06.png?v=1',link:memberDomain + '/orderlist.html?state=6',"mini":"/pages/member/order/index?state=6",linkInfo:{ "linkText":"待分享", "selfSetTel":0 },btnText:'待分享',code:'daifenxiang'},
                {id:7,text:'退款售后',icon:defaultPath + 'order_07.png?v=1',link:memberDomain + '/orderlist.html?state=7',"mini":"/pages/member/order/index?state=7",linkInfo:{ "linkText":"退款售后", "selfSetTel":0 },btnText:'退款售后',code:'tuikuanshouhou'},
                {id:8,text:'全部',icon:defaultPath + 'order_08.png?v=1',link:memberDomain + '/orderlist.html',"mini":"/pages/member/order/index",linkInfo:{ "linkText":"个人订单(全部)", "selfSetTel":0 },btnText:'全部',code:'all'},
            ], //订单选项, //选择的按钮
            style:{
                borderRadius:24,
                marginTop:22,
    ...
    created(){
        ...
        if(changePage && changePage == '1'){ //从其他设置切换过来的 需要提示
            let newMemberPlatform = localStorage.getItem('newMemberPlatform',that.currChosed_cp)
            newMemberPlatform = typeof(newMemberPlatform) == 'string' ? JSON.parse(newMemberPlatform) : newMemberPlatform;
            if(newMemberPlatform && newMemberPlatform.id){
                // newMemberPlatform = JSON.parse(newMemberPlatform)
                let platform = newMemberPlatform.name
                let str = platform;
                that.$message({
                    iconClass:'smIcon',
                    customClass:'successSkip',
                    dangerouslyUseHTMLString: true,
                    message: '<span>已切换至'+(str)+'个人中心设置</span>',
                })
                setTimeout(() => {
                    ...
                    localStorage.removeItem('newMemberPlatform')
                }, 3000);
            }
        }
    ...
    mounted(){
        ...
        if(that.hasSetModel){
            ...
            that.showholeModelStylePop = true;
        }
        // 初始化模板
    ...
    watch:{
        ...
        'memberCompFormData.style.bg_color':function(val){
            const that = this;
            that.setHeaderImgColor(1); //设置头部颜色
        },
        
        'memberCompFormData.vipCard.theme':{
            handler:function(val){
                const that = this;
                let ind = that.vipCardDefaultOptions.findIndex(item => {
                    return item.id == val
                });
                if($('rightCon.show .vipCardSetBox .column_chose').length){
                    that.checkLeft(ind,$('rightCon.show .vipCardSetBox .column_chose'))
                }
            },
            immediate:true,
        },
        ...
        currEditPart(val){
            const that = this;
            $('.rightCon.show .memberInfoStyle,.rightCon.show .orderStyle').scrollTop(0)
            that.showContentSet = true, //内容设置展开/收起
            that.showVipSet = true, //会员设置展开/收起
            that.showNumberSet = true, //数字设置展开/收起
            that.financeInfoSet = true, //财务设置
            that.$nextTick(() => {
                if(val == 7 ){
                    that.checkLeft(that.advFormData.column - 1,$('.advBox .column_chose')) 
                }
                ...
                if(!val){
                    ...
                    $('.fixedTop').removeClass('show').addClass('bottomFadeOut');
                    setTimeout(() => {
                        $('.fixedTop').removeClass('bottomFadeOut');
                    }, 300);
                }
        ...
        'memberCompFormData.vipCard.theme':{
            handler:function(val){
                ...
                if($('.vipCardSetBox .column_chose').length){
                    that.checkLeft(ind,$('.vipCardSetBox .column_chose'))
                }
            },
            immediate:true
    ...
    methods:{
        ...
        // 初始化数据
        initModel(data,reset){ //reset 表示重新选择模板
            const that = this;
            let compArrs = data['compArrs'] ? JSON.parse(JSON.stringify(data['compArrs'])) : []
            that.memberCompFormData = data['memberComp'] ? JSON.parse(JSON.stringify(data['memberComp'])) : that.memberCompFormData
            ...
            if(reset){ 
                ...
                for(let i = 0; i < compArrs.length; i++){
                    switch(compArrs[i].id){
                        case 2:
                            that.orderDefault = JSON.parse(JSON.stringify(compArrs[i].content));
                            break;
                        case 3:
                            that.financeDefault = JSON.parse(JSON.stringify(compArrs[i].content));
                            break;
                        case 4:
                            // that.iconsDefault = JSON.parse(JSON.stringify(compArrs[i].content));
                            that.iconsFormData = JSON.parse(JSON.stringify(compArrs[i].content));
                            break;
                        case 5:
                            // that.listDefault = JSON.parse(JSON.stringify(compArrs[i].content));
                            that.listFormData = JSON.parse(JSON.stringify(compArrs[i].content));
                            break;
                        case 6:
                            that.wechatDefault = JSON.parse(JSON.stringify(compArrs[i].content));
                            break;
                        case 7:
                            that.advDefault = JSON.parse(JSON.stringify(compArrs[i].content));
                            break;
                        case 8:
                            that.titleDefault = JSON.parse(JSON.stringify(compArrs[i].content));
                            break;
                    }
                }
                ...
                let theme = data.memberComp.theme;
                let currChoseStyle = that.memberDefaultStyle.find(item => {
                    return theme == item.theme
                })
                that.memberCompDefault = JSON.parse(JSON.stringify(currChoseStyle))
            }



            that.$nextTick(() => {
                that.currMemberStyle =  that.memberDefaultStyle.findIndex(item => {
                    return item.theme == that.memberCompFormData.theme
                })
                // 色彩选择
                if(!pickr2){
                ...
                $('body').delegate('.pcr-reset','click',function(){
                    ...
                    let t = $(this),result = '',bgtype = 'color'
                    if(type === '1'){
                        // 待补充
                        that.memberCompFormData.bgType = 'image'
                        // that.memberCompFormData.style.bg_image = defaultPath + 'bg_01.png'; //背景图
                        that.memberCompFormData.style.bg_image = that.memberCompDefault.style.bg_image
                        result = that.memberCompFormData.style.bg_image;
                        bgtype = 'image'
                    }else if(type == 2){
                        let id = that.memberCompFormData.vipCard.theme
                        ...
                        if(vipCardDefault.style.bgType == 'image'){
                            ...
                            result = vipCardDefault.style.backimg
                        }else{
                            bgtype = 'color'
                            that.memberCompFormData.vipCard.style.background = vipCardDefault.style.background
                            result = vipCardDefault.style.background
                        }
                        
                        that.memberCompFormData.vipCard.style.bgType = vipCardDefault.style.bgType;
                    }else if(type == 3){
                        bgtype = that.financeDefault.bgType
                        that.financeFormData.style.bg_color = that.financeDefault.style.bg_color;
                        that.financeFormData.style.bg_image = that.financeDefault.style.bg_image;
                        that.financeFormData.bgType = that.financeDefault.bgType
                        result = that.financeDefault.style.bgType == 'image' ?  that.financeDefault.style.bg_image : that.financeDefault.style.bg_color;
                    }
                    t.closest('.pickr').find('.pcr-button').css({
                        background:bgtype == 'color' ? result : 'url('+ result +') no-repeat center/cover'
                    })
                    t.closest('.pcr-interaction').find('.pcr-result').val(bgtype == 'color'? result : '')
                })
            ...
            //     }
            // }
            if(!that.pageFormData.hasOwnProperty('h5FixedTop')){
                that.$set(that.pageFormData,'h5FixedTop',1)
            }
            if(!that.pageFormData.hasOwnProperty('bgType')){
                that.$set(that.pageFormData,'bgType','color')
                that.$set(that.pageFormData.style,'bgColor1','#f5f7fa')
                that.$set(that.pageFormData.style,'bgColor2','')
                that.$set(that.pageFormData.style,'start',30)

            }
            if(!that.memberCompFormData.hasOwnProperty('showHeader')){
                that.$set(that.memberCompFormData,'showHeader',1)
            }

            that.$nextTick(() => {
                that.setHeaderImgColor(); //设置头部颜色
            })
        },
        // 修改全局变量
            ...
            if (m.state == "SUCCESS") {
                ...
                switch (key){
                    ...
                    case 'memberBg': //会员组件背景图
                        that.memberCompFormData.style.bgID = ''
        ...
        getStyle(box,type,content){  //box ，type => 区分样式  content => 样式数据
            ...
            if(box == 'numberCountBox'){ //边距 ，背景色 ，边框
                ...
                if(type == 'tipNum'){
                    ...
                    styleStrArr.push('font-size:'+  (content.btnStyle.fontSize / 2) + 'px'  )
                }else if(!type){
                ...
                styleStrArr.push('margin:0 '+ (content.style.marginLeft / 2) +'px '); //边距
                if(that.currPlatform.id == 'wxmini'){
                    styleStrArr.push('margin-right:0'); //边距
                }
            }else if(box == 'pageBtn'){
            ...
            let sortable2 = Sortable.create($('.otherSort.otherBox')[0],{
                ...
                onEnd: function(evt){
                    ...
                    for(let i = 0; i < arrNew.length; i++){
                        newArr.push(that.showContainerArr[arrNew[i]])
                    }
                    that.showContainerArr = []
                    that.$nextTick(() => {
                        that.showContainerArr = newArr
        ...
        sureChoseMemberBg(){
            const that = this;
            let pic = ''
            if(that.memberCompFormData.style.bgID === ''){ //手动上传的背景图
                pic = that.memberBg
            }else{
                pic = that.defaultPath + 'bg_' + (that.memberCompFormData.style.bgID > 9 ? that.memberCompFormData.style.bgID : ('0' + that.memberCompFormData.style.bgID)) + '.png'
            }
        ...
        count_infoData(){
            ...
            if(that.memberCompFormData.theme == 3 || that.memberCompFormData.theme == 4){
                infoData = infoData.concat('fans','follow','zan')
            }
        ...
        activeChangeColor(color,type,name){
            ...
            if(name == 'qiandaoBtn'){
                ...
                that.memberCompFormData.vipCard.titleStyle[type] =  color;
            }else if(name == 'vipsubStyle'){
                that.memberCompFormData.vipCard.subStyle[type] =  color;
           
            }else if(name == 'vipbtnStyle'){
                that.memberCompFormData.vipCard.btnStyle.style[type] =  color;
                ...
                if(type != 'qiandao_bg'){
                    ...
                    that.iconsFormData['qiandao'].style.background = color;
                ...
                }else if(type != 'qiandao_bg'){
                    that.listFormData[type].style.color = color;
                }else{
                    that.listFormData['qiandao'].style.background = color;

                }
            }else if(name == 'financeFormData'){
                if(type == 'title'){
                    that.financeFormData.title.style.color = color;
                }else if(type == 'more'){
                    that.financeFormData.more.style.color = color;
                }else{
                    that.financeFormData[type].color = color
                }
            }
        },
        ...
        changeThemeStyle(style){
            ...
            if(style == 'light'){
                ...
                that.dark.arr_color =   that.memberCompFormData.qiandaoBtn.style.arr_color;
                that.memberCompFormData.numberCount.numberStyle.color = '#FFFFFF'
                that.memberCompFormData.numberCount.titleStyle.color = '#FFFFFF'
                that.memberCompFormData.qiandaoBtn.style.arr_color = '#FFFFFF'
            }else{
                ...
                that.memberCompFormData.qiandaoBtn.style.arr_color = that.dark.arr_color
            }
        },
        ...
        // 选择会员头部风格
        choseMemberStyle(item,ind){
            const that = this;
            that.currMemberStyle = ind
            // that.memberCompFormData = JSON.parse(JSON.stringify(item))
        },


        // 确定选择
        sureChoseMemberStyle(){
            const that = this;
            // let choseItem = that.memberDefaultStyle.find(item => {
            //     return item.theme == that.currMemberStyle
            // });
            that.memberCompFormData = JSON.parse(JSON.stringify(that.memberDefaultStyle[that.currMemberStyle]));
            that.showMemberTopStylePop = false;
            if(!that.memberCompFormData.hasOwnProperty('showHeader')){
        ...
        changeLink(str){
            ...
            for(let i = 0; i < jsonArr.length; i++){
                if(i == (jsonArr.length - 2)){
                    currLink = obj[jsonArr[i]]
                    break;
                }else{
                    obj = obj[jsonArr[i]]
                }
            }
            if(currLink.link && currLink.linkInfo && !currLink.linkInfo.linkText){
                that.linkSetForm.slefSet = 1
                that.linkSetForm.linkType = (currLink.link.indexOf('tel:') == 0 ? 1 : 0);
                that.linkSetForm.selfLink = currLink.link.indexOf('tel:') == -1 ? currLink.link: '';
                that.linkSetForm.selfTel = currLink.link.indexOf('tel:') == 0 ? currLink.link.replace('tel:','') : '';
        ...
        toSearch(e){
            const that = this;
            let searchResult = [];
            for(let i = 0; i < that.linkList.length; i++){
                let group = that.linkList[i];
        ...
        sureChangeLink(){
            ...
            for(let i = 0; i < jsonArr.length; i++){
                if(i == (jsonArr.length -1)){
                    ...
                    if(obj.mini && that.linkSetForm.mini){
                        that.$set(obj,'mini',that.linkSetForm.mini)
                    }
                    let linkInfo = {
                        linkText: that.linkSetForm.slefSet ? '' : that.linkSetForm.linkText,
                        selfSetTel:that.linkSetForm.linkType
                    }
                    if(that.linkSetForm.mini){
                        that.$set(linkInfo,'mini',that.linkSetForm.mini)
                        that.$set(obj,'mini',that.linkSetForm.mini)
                    }else{
                        that.$delete(linkInfo,'mini')
        ...
        checkOrderOptionInd(id){
            const that = this;
            let ind = that.orderFormData.orderOption.findIndex(item => {
                return item.id == id
            })
            return ind
        },
        ...
        sureChangePlatform(){
            ...
            localStorage.setItem('newMemberPlatform',JSON.stringify(that.currChosePlatform))
            let url =  '?' + str
        ...
        getMiniQr(){
            ...
            if(!that.currPlatform.id || that.currPlatform.id == 'wxmini'){
                let miniPath = '/pages/member/index/index?preview=1'
                $.ajax({
        ...
        setHeaderImgColor(reset){
            const that = this;
            let color = ''
            if(!that.pageFormData.style.bgImgColor || reset){
                if(that.memberCompFormData.bgType == 'color'){
                    color = that.memberCompFormData.style.bg_color
                    that.$set(that.pageFormData.style,'bgImgColor',color)
                }else{ //获取图片主色
                    that.getImageColor(that.memberCompFormData.style.bg_image,'pageFormData.style.bgImgColor')
                }
            }
        },
        ...
        */
        changeObj(jsonStr,val){
         ...
         // 色彩选择器颜色改变
         activeChangeColor_new(color,changeStr){
            const that = this;
            if(color){
                color = that.colorHex(color);
            }else{
