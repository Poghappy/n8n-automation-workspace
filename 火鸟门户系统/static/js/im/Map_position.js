...
function map_url(pageData){
	...
	if (ua.match(/MicroMessenger/i) == "micromessenger") {
        ...
        IMOpenMap_URL = "https://api.map.baidu.com/marker?location="+tmap_lat+","+tmap_lng+"&title="+pageData.title+"&content="+pageData.address+"&output=html"
	}
...
$(function(){
  $('body').delegate('.IMappMapBtn', 'click', function(e){
  	var t = $(this),p=t.parents('.im-post_content');
  	 pageData = {
  		mapType: typeof site_map == 'undefined' ? 'baidu' : site_map,
  		lng    : p.attr('data-lng'),
  		lat    : p.attr('data-lat'),
