<?php /* Smarty version Smarty-3.1.21-dev, created on 2025-07-27 19:06:18
         compiled from "/www/wwwroot/hawaiihub.net/admin/templates/article/articleConfig.html" */ ?>
<?php /*%%SmartyHeaderCode:16916724296886082ad34312-34479537%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd5d88641d38fd472e9d7ce9ddac935168ad0e93' => 
    array (
      0 => '/www/wwwroot/hawaiihub.net/admin/templates/article/articleConfig.html',
      1 => 1753593716,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16916724296886082ad34312-34479537',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'articleTypeOptionVal' => 0,
    'articleTypeOption' => 0,
    'articleTypeOptionName' => 0,
    'router' => 0,
    'tplList' => 0,
    'articleTemplate' => 0,
    'tplItem' => 0,
  ...
  'unifunc' => 'content_6886082b02f761_00434774',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6886082b02f761_00434774')) {function content_6886082b02f761_00434774($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_radios')) include '/www/wwwroot/hawaiihub.net/include/tpl/plugins/function.html_radios.php';
...
" /> 张
    ...
    <dl class="clearfix">
      ...
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"rewardSwitch",'values'=>$_smarty_tpl->tpl_vars['rewardSwitch']->value,'checked'=>$_smarty_tpl->tpl_vars['rewardSwitchChecked']->value,'output'=>$_smarty_tpl->tpl_vars['rewardSwitchNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label>打赏配置：</label></dt>
      <dd>
        <div class="input-prepend input-append">
            <span class="add-on">最大金额</span>
            <input class="span1" id="rewardLimit" name="rewardLimit" type="text" value="<?php echo $_smarty_tpl->tpl_vars['rewardLimit']->value;?>
">
            <span class="add-on">元</span>
        </div><br />
        <div class="input-prepend">
            <span class="add-on" style="vertical-align: top!important;">金额选项</span>
            <textarea class="input-small" style="width: 75px; height: 105px;" name="rewardOption" id="rewardOption"><?php echo $_smarty_tpl->tpl_vars['rewardOption']->value;?>
</textarea>
        </div>
        <p style="padding-left: 0; font-size: 12px; color: #999;">一行一个金额，最多支持5个，移动端显示前3个！</p>
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label>分站数据共享：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"dataShareSwitch",'values'=>$_smarty_tpl->tpl_vars['dataShareSwitch']->value,'checked'=>$_smarty_tpl->tpl_vars['dataShareSwitchChecked']->value,'output'=>$_smarty_tpl->tpl_vars['dataShareSwitchNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>
      ...
      <dl class="clearfix huodongOpen">
        <dt><label for="flag">页面显示内容开关：</label></dt>
        <dd class="radio">
          <?php echo smarty_function_html_checkboxes(array('name'=>"articleTypeOption",'values'=>$_smarty_tpl->tpl_vars['articleTypeOptionVal']->value,'checked'=>$_smarty_tpl->tpl_vars['articleTypeOption']->value,'output'=>$_smarty_tpl->tpl_vars['articleTypeOptionName']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

          <span class="input-tips" style="display:inline-block;"><s></s>不勾选时，前台页面将隐藏相关内容。</span>
        </dd>
      </dl>
  </div>
...
" data-imglist=""><div></div><span></span></div>
        ...
        <ul id="listSection_grant_tpl" class="listSection thumblist fn-clear" style="display:inline-block;"><li id="WU_FILE_stpl_1"><a href="/include/attachment.php?f=<?php echo $_smarty_tpl->tpl_vars['selfmediaGrantTpl']->value;?>
