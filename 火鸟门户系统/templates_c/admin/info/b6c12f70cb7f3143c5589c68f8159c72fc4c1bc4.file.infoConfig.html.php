<?php /* Smarty version Smarty-3.1.21-dev, created on 2025-07-27 19:05:57
         compiled from "/www/wwwroot/hawaiihub.net/admin/templates/info/infoConfig.html" */ ?>
<?php /*%%SmartyHeaderCode:99165403768860815d187e4-76187523%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b6c12f70cb7f3143c5589c68f8159c72fc4c1bc4' => 
    array (
      0 => '/www/wwwroot/hawaiihub.net/admin/templates/info/infoConfig.html',
      1 => 1753596910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '99165403768860815d187e4-76187523',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'commentCheckNames' => 0,
    'fabuCheckPhoneNum' => 0,
    'fabuCheckPhoneChecked' => 0,
    'fabuCheckPhoneNames' => 0,
    'dataShareSwitch' => 0,
    'dataShareSwitchChecked' => 0,
    'dataShareSwitchNames' => 0,
    'expireShowSwitch' => 0,
    'expireShowSwitchChecked' => 0,
    'expireShowSwitchNames' => 0,
    'fabuMapConfig' => 0,
    'fabuMapConfigChecked' => 0,
    'fabuMapConfigNames' => 0,
    'fabuMapDisplayLocation' => 0,
    'fabuMapDisplayLocationChecked' => 0,
    'fabuMapDisplayLocationNames' => 0,
    'fenXiaoSwitch' => 0,
    'fenXiaoSwitchChecked' => 0,
    'fenXiaoSwitchNames' => 0,
    'fabuTips' => 0,
    'router' => 0,
    'tplList' => 0,
    'articleTemplate' => 0,
  ...
  'unifunc' => 'content_68860815f20604_21944858',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_68860815f20604_21944858')) {function content_68860815f20604_21944858($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_radios')) include '/www/wwwroot/hawaiihub.net/include/tpl/plugins/function.html_radios.php';
...
<style media="screen">
  ...
  .input-append.open{position: relative}
  .validObj .input-append {margin-bottom: 0;}
</style>
<?php echo '<script'; ?>
>
...
<div class="btn-group config-nav" data-toggle="buttons-radio">
  ...
  <button type="button" class="btn" data-type="infotime">延长有效期</button>
</div>
...
" />
  ...
  <dl class="clearfix">
    <dt><label for="flag">用户激励：</label></dt>
    <dd class="radio">
      <?php echo smarty_function_html_checkboxes(array('name'=>"excitationopen",'values'=>$_smarty_tpl->tpl_vars['excitationopt']->value,'checked'=>$_smarty_tpl->tpl_vars['excitationopen']->value,'output'=>$_smarty_tpl->tpl_vars['excitationnames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>
  ...
  <dl class="clearfix">
    ...
    <dd>
      <div class="input-append">
        <input class="input-mini" type="number" min="0" name="cost" value="<?php echo $_smarty_tpl->tpl_vars['cost']->value;?>
"/>
...
<!--    <dd>-->
<!--      <div class="input-prepend input-append">-->
<!--        <span class="add-on">平台收取服务费</span>-->
<!--        <input class="input-mini" type="text" name="servicePrice" value="<?php echo $_smarty_tpl->tpl_vars['servicePrice']->value;?>
">-->
<!--        <span class="add-on" style="display: inline-block;">%</span>-->
<!--      </div>-->
<!--    </dd>-->
...
" /> 张
    ...
    <dl class="clearfix">
      <dt><label>发布信息验证手机：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"fabuCheckPhone",'values'=>$_smarty_tpl->tpl_vars['fabuCheckPhoneNum']->value,'checked'=>$_smarty_tpl->tpl_vars['fabuCheckPhoneChecked']->value,'output'=>$_smarty_tpl->tpl_vars['fabuCheckPhoneNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>
    ...
    <dl class="clearfix">
      ...
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"dataShareSwtich",'values'=>$_smarty_tpl->tpl_vars['dataShareSwitch']->value,'checked'=>$_smarty_tpl->tpl_vars['dataShareSwitchChecked']->value,'output'=>$_smarty_tpl->tpl_vars['dataShareSwitchNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

        <span class="input-tips" style="display:inline-block;"><s></s>启用后，分站数据将会打通共享，每个分站下的模块数据将会统一。</span>
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label>过期后继续显示：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"expireShowSwtich",'values'=>$_smarty_tpl->tpl_vars['expireShowSwitch']->value,'checked'=>$_smarty_tpl->tpl_vars['expireShowSwitchChecked']->value,'output'=>$_smarty_tpl->tpl_vars['expireShowSwitchNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

        <span class="input-tips" style="display:inline-block;"><s></s>启用后，即使信息已经过期，前台页面也继续显示。</span>
      </dd>
    </dl>

    <dl class="clearfix">
        <dt><label>发布信息时定位功能配置：</label></dt>
        <dd class="radio">
          <?php echo smarty_function_html_radios(array('name'=>"fabuMapConfig",'values'=>$_smarty_tpl->tpl_vars['fabuMapConfig']->value,'checked'=>$_smarty_tpl->tpl_vars['fabuMapConfigChecked']->value,'output'=>$_smarty_tpl->tpl_vars['fabuMapConfigNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

          <p style="padding-left: 0; font-size: 12px; padding-top: 10px; color: #999;">系统默认：不限制用户所在位置是否开通分站；<br>选项一：用户当前位置没有开通分站，强制不允许发布信息；<br>选项二：用户当前位置没有开通分站，提示用户需调整地图位置为所在分站，否则不允许发布信息；<br>注意：如果设置为选项一或选项二时，地图位置微调限制为2KM以内！</p>
        </dd>
    </dl>

    <dl class="clearfix">
        <dt><label>发布信息时不显示位置选项：</label></dt>
        <dd class="radio">
          <?php echo smarty_function_html_radios(array('name'=>"fabuMapDisplayLocation",'values'=>$_smarty_tpl->tpl_vars['fabuMapDisplayLocation']->value,'checked'=>$_smarty_tpl->tpl_vars['fabuMapDisplayLocationChecked']->value,'output'=>$_smarty_tpl->tpl_vars['fabuMapDisplayLocationNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

          <span class="input-tips" style="display:inline-block;"><s></s>设置为显示时，用户可以设置不显示位置信息。<a href="/static/images/admin/fabuMapDisplayLocation.png" target="_blank">截图说明</a></span>
        </dd>
    </dl>


      <dl class="clearfix hide">
        <dt><label>分佣开关：</label></dt>
        <dd class="radio">
          <?php echo smarty_function_html_radios(array('name'=>"fenXiao",'values'=>$_smarty_tpl->tpl_vars['fenXiaoSwitch']->value,'checked'=>$_smarty_tpl->tpl_vars['fenXiaoSwitchChecked']->value,'output'=>$_smarty_tpl->tpl_vars['fenXiaoSwitchNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

          <span class="input-tips" style="display:inline-block;"><s></s>启用后，当前模块下的所有交易会有分佣流程。</span>
        </dd>
      </dl>
      <dl class="clearfix">
        <dt><label for="fabuTips" class="sl">发布信息声明：</label></dt>
        <dd>
          <textarea class="input-xxlarge" name="fabuTips" id="fabuTips"><?php echo $_smarty_tpl->tpl_vars['fabuTips']->value;?>
</textarea>
          <div style="font-size: 12px; padding-top: 10px;">如：发布前请阅读并遵守《平台发布须知》，禁止发布医疗 药品、金融、网络兼职等虚假诈骗信息<br />每个分类均可独立设置该声明，<a class="addPage" href="info/infoType.php" data-id="infoTypephp" data-name="信息分类" data-action="info">点击去配置</a></div>
        </dd>
      </dl>
  </div>
  <div class="item hide" id="tplList">
    <div class="tpl-list">
      <h5 class="stit"><span class="label label-info">电脑端：</span><label class="routerTips" data-toggle="tooltip" data-placement="bottom" data-original-title="如果模板使用了自定义路由，请勾选此项，程序将不再对url地址做任何拦截处理，选择使用的模板名称前如果有vue标识，表示需要开启此项！"><input type="checkbox" id="router" name="router" value="1"<?php if ($_smarty_tpl->tpl_vars['router']->value==1) {?> checked<?php }?> />开启自定义路由 <i class="icon-question-sign"></i></label></h5>
      <ul class="clearfix">
...
" />
    ...
    <div class="tpl-list touch">
      <h5 class="stit"><span class="label label-warning">移动端：</span><label class="routerTips" data-toggle="tooltip" data-placement="bottom" data-original-title="如果模板使用了自定义路由，请勾选此项，程序将不再对url地址做任何拦截处理，选择使用的模板名称前如果有vue标识，表示需要开启此项！"><input type="checkbox" id="touchRouter" name="touchRouter" value="1"<?php if ($_smarty_tpl->tpl_vars['touchRouter']->value==1) {?> checked<?php }?> />开启自定义路由 <i class="icon-question-sign"></i></label></h5>
      <ul class="clearfix">
        <?php  $_smarty_tpl->tpl_vars['tplItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tplItem']->_loop = false;
...
" />
    ...
    <div class="item hide validObj">

        <div class="alert alert-success" style="margin:10px 10px 15px 50px;"><button type="button" class="close" data-dismiss="alert">×</button>普通会员和vip会员的默认有效时长请到用户等级特权设置页面配置，<a class="addPage" href="member/memberLevelAuth.php" data-id="memberLevelAuthphp" data-name="特权设置" data-action="member">点击打开</a><br />当前页面的延长有效期时长价格为默认配置，每个分类可独立设置该规则，<a class="addPage" href="info/infoType.php" data-id="infoTypephp" data-name="信息分类" data-action="info">点击去配置</a></div>

      <dl class="clearfix">
        <dt><label for="valid" >永久有效：</label></dt>
        <?php if ($_smarty_tpl->tpl_vars['cfg_valid']->value) {?>
        <?php  $_smarty_tpl->tpl_vars['valid'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['valid']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['cfg_valid']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['valid']->key => $_smarty_tpl->tpl_vars['valid']->value) {
$_smarty_tpl->tpl_vars['valid']->_loop = true;
?>
        <dd>
            <div class="input-append hide">
              <input class="input-small day"  name="valid[day][]" value="3650" type="number">
              <span class="add-on">天</span>
            </div>
            <div class="input-append">
              <input class="input-small price" step="0.01" name="valid[price][]" value="<?php echo $_smarty_tpl->tpl_vars['valid']->value['price'];?>
" type="number">
              <span class="add-on">元</span>
            </div>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <div class="input-append">
                <label><input type="checkbox" name="isvaild" value="1" <?php if ($_smarty_tpl->tpl_vars['cfg_isvalid']->value=="1") {?> checked<?php }?> > 是否开启（勾选表示启用永久有效功能）</label>
            </div>
        </dd>
        <?php } ?>
        <?php } else { ?>
        <dd>
            ...
            <div class="input-append">
              <input class="input-small price" step="0.01" name="valid[price][]" value="" type="number">
              <span class="add-on">元</span>
            </div>
        </dd>
        <?php }?>
      ...
      <dl class="clearfix">
        <dt><label for="">企业会员每周发布：</label></dt>
        <dd>
            <div class="input-append">
              <input class="input-small day" name="qymember" value="<?php echo $_smarty_tpl->tpl_vars['cfg_qymember']->value;?>
" type="number">
      ...
      <dl class="clearfix">
        <dt><label for="">企业会员默认有效时长：</label></dt>
        <?php if ($_smarty_tpl->tpl_vars['cfg_qymembervalid']->value) {?>
        <?php  $_smarty_tpl->tpl_vars['qymembervalid'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['qymembervalid']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['cfg_qymembervalid']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['qymembervalid']->key => $_smarty_tpl->tpl_vars['qymembervalid']->value) {
$_smarty_tpl->tpl_vars['qymembervalid']->_loop = true;
?>
        <dd>
            <div class="input-append">
              <input class="input-small day" name="qymembervalid[day][]" value="<?php echo $_smarty_tpl->tpl_vars['qymembervalid']->value['day'];?>
" type="number">
              <span class="add-on">天</span>
            </div>
        </dd>
        ...
        <dd>
            <div class="input-append">
              <input class="input-small day" name="qymembervalid[day][]" value="" type="number">
              <span class="add-on">天</span>
            </div>
          <!--          <td>-->
          <!--            <div class="input-append">-->
          <!--              <input class="input-small price" step="0.01" name="membervalid[price][]" value="0" type="number">-->
          <!--              <span class="add-on">元</span>-->
          <!--            </div>-->
          <!--          </td>-->
        </dd>
      ...
      <dl class="clearfix">
        <dt><label>延长有效期：</label></dt>
        <dd>
          <h5 class="stit" style="margin-top: 0;"><span class="label label-info"></span></h5>
          <div class="priceWrap">
            <table class="table table-hover table-bordered table-striped refreshSmartTable">
              ...
              <?php if ($_smarty_tpl->tpl_vars['info_refreshSmart']->value[0]['daytext']==1) {?>
              <?php $_smarty_tpl->tpl_vars['infoday'] = new Smarty_variable($_smarty_tpl->tpl_vars['info_refreshSmart']->value[0]['day']*365, null, 0);?>
              <?php } elseif ($_smarty_tpl->tpl_vars['info_refreshSmart']->value[0]['daytext']==2) {?>
              <?php $_smarty_tpl->tpl_vars['infoday'] = new Smarty_variable($_smarty_tpl->tpl_vars['info_refreshSmart']->value[0]['day']*30, null, 0);?>
              <?php } else { ?>
              <?php $_smarty_tpl->tpl_vars['infoday'] = new Smarty_variable($_smarty_tpl->tpl_vars['info_refreshSmart']->value[0]['day'], null, 0);?>
              <?php }?>
              <?php $_smarty_tpl->tpl_vars['danjia'] = new Smarty_variable($_smarty_tpl->tpl_vars['info_refreshSmart']->value[0]['price']/$_smarty_tpl->tpl_vars['infoday']->value, null, 0);?>
              <?php $_smarty_tpl->tpl_vars['danjia'] = new Smarty_variable(sprintf("%.2f",$_smarty_tpl->tpl_vars['danjia']->value), null, 0);?>
              ...
              <tr>
                <td>
                  <div class="input-append validA">
                    <input class="input-small day" name="info_refresh[day][]" value="<?php echo $_smarty_tpl->tpl_vars['refresh']->value['day'];?>
" type="number">
                    <input class="dayText" name="info_refresh[daytext][]" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['refresh']->value['daytext'])===null||$tmp==='' ? 2 : $tmp);?>
" type="hidden">
                    <button type="button" class="btn dropdown-toggle " data-toggle="dropdown" data-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['refresh']->value['daytext'])===null||$tmp==='' ? 2 : $tmp);?>
"><?php if ($_smarty_tpl->tpl_vars['refresh']->value['daytext']==1) {?>年<?php } elseif ($_smarty_tpl->tpl_vars['refresh']->value['daytext']==3) {?>天<?php } else { ?>月<?php }?><span class="caret"></span></button>
...
" type="number">
                    <span class="add-on">元</span>
                    <?php if ($_smarty_tpl->tpl_vars['refresh']->value['daytext']==1) {?>
                    <?php $_smarty_tpl->tpl_vars['pingjun'] = new Smarty_variable($_smarty_tpl->tpl_vars['danjia']->value*($_smarty_tpl->tpl_vars['refresh']->value['day']*365), null, 0);?>
                    <?php } elseif ($_smarty_tpl->tpl_vars['refresh']->value['daytext']==2) {?>
                    <?php $_smarty_tpl->tpl_vars['pingjun'] = new Smarty_variable($_smarty_tpl->tpl_vars['danjia']->value*($_smarty_tpl->tpl_vars['refresh']->value['day']*30), null, 0);?>
                    <?php } else { ?>
                    <?php $_smarty_tpl->tpl_vars['pingjun'] = new Smarty_variable($_smarty_tpl->tpl_vars['danjia']->value*$_smarty_tpl->tpl_vars['refresh']->value['day'], null, 0);?>
                    <?php }?>
                    <?php $_smarty_tpl->tpl_vars['jun'] = new Smarty_variable($_smarty_tpl->tpl_vars['pingjun']->value-$_smarty_tpl->tpl_vars['refresh']->value['price'], null, 0);?>
                   <?php if ($_smarty_tpl->tpl_vars['jun']->value>1) {?>
                    <span class="add-on">优惠<?php echo $_smarty_tpl->tpl_vars['jun']->value;?>
元</span>
                    <?php }?>
                  </div>
              ...
              <tr>
                <td>
                  <div class="input-append validA">
                    <input class="input-small day" id="info_refreshday" name="info_refresh[day][]" value="" type="number">
                    <input class="dayText" name="info_refresh[daytext][]" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['refresh']->value['daytext'])===null||$tmp==='' ? 2 : $tmp);?>
" type="hidden">
                    <button class="btn dropdown-toggle " data-toggle="dropdown" data-id="2">月<span class="caret"></span></button>
                    <ul class="dropdown-menu">
                      <li><a href="javascript:;" data-id="1">年</a></li>
                      <li><a href="javascript:;" data-id="2">月</a></li>
                      <li><a href="javascript:;" data-id="3">天</a></li>
...
>-->
<!--  $(function (){-->
<!--    $(".validA .dropdown-menu li").click(function (){-->
<!--      var t = $(this);-->
