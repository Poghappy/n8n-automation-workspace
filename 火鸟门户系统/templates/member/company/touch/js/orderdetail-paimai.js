$(function(){
  ...
  $('.fahuo').click(function(){
    ...
    if(!t.hasClass('fahuo_direct')){
      ...
      confirmPop(optionsPop,function(){
        ...
        $.ajax({
          url: "/include/ajax.php?service=paimai&action=delivery",
          data: data.join("&"),
          type: "POST",
          dataType: "json",
  ...
  $('#typeback').click(function(){
	...
	$(".tuikuan").bind("click", function(){
		...
		if(confirm(langData['siteConfig'][20][407])){
			...
			$.ajax({
				url: "/include/ajax.php?service=paimai&action=refundPay",
				data: "id="+detailID,
				type: "POST",
				dataType: "json",
				success: function (data) {
  ...
  $("#submit").bind("click", function(){
    ...
    $.ajax({
      url: masterDomain+"/include/ajax.php?service=paimai&action=refundReply",
      data: data,
      type: "POST",
      dataType: "jsonp",
      success: function (data) {
