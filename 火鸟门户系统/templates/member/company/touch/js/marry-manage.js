    ...
    data: {
        ...
        typeList: [
            ...
            },
            {
                title: '婚庆商家',
                child: [
                    { id: '9', typename: "婚礼策划", select: false },
                    { id: '10', typename: "租婚车", select: false },
                    { id: '1', typename: "婚纱摄影", select: false },
                    { id: '2', typename: "摄影跟拍", select: false },
                    { id: '7', typename: "婚礼主持", select: false },
                    { id: '3', typename: "珠宝首饰", select: false },
                    { id: '4', typename: "摄像跟拍", select: false },
                    { id: '5', typename: "新娘跟妆", select: false },
                    { id: '6', typename: "婚纱礼服", select: false },
                ]
            }
        ],//经营类别
        selectType: [], //选中的类别id
