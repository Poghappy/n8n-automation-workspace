            ...
            success: function (data) {
                if(data && data.state == 100){
                    ...
                    if(skuArr.length > 0){
                        ...
                        specHtml.push('<h2>多规格商品需单个设置拼购价与活动库存</h2>');
                        ...
                        for (var m = 0; m < foArr.length; m++) {
                            ...
                            specHtml.push('<div><input type="number" class="ptinventory" id="hd_inventory_'+foArr[m].spe+'" name="hd_inventory_'+foArr[m].spe+'" placeholder="输入活动库存" onkeyup="zhengshu(this)"><i>件</i></div>');
                            specHtml.push('<div><input type="number" class="ptprice" id="hd_price_'+foArr[m].spe+'" name="hd_price_'+foArr[m].spe+'" placeholder="输入拼团价" onkeyup="xiaoshu(this)"><i>'+echoCurrency('short')+'</i></div>');
                            specHtml.push('</dd>');
                            specHtml.push('</dl>');                           
