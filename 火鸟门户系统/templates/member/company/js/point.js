		...
		success: function (data) {
			if(data && data.state != 200){
              ...
              html.push('<td style="padding-left: 30px;">'+(judgeTime(time) ? balance : '-')+'</td>');
						...
						objId.html('<table><thead class="thead"><tr><th class="fir"></th><th>'+langData['siteConfig'][19][382]+'</th><th style="padding-left: 30px;">'+langData['siteConfig'][19][385]+'</th><th style="padding-left: 30px;">'+langData['siteConfig'][56][41]+'</th><th>'+langData['siteConfig'][19][384]+'</th></tr></thead>'+html.join("")+'</table>');
