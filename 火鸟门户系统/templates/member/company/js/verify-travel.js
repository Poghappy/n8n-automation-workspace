$(function(){
	...
	//新增密码框
	var newPasswdHtml = '<dl class="fn-clear" data-required="1"><dt><span>*</span>'+langData['siteConfig'][5][0]+'：</dt><dd><input type="text" name="passwd[]" class="inp" maxlength="14" data-title="'+langData['travel'][13][53].replace('1','12')+'" /><a href="javascript:;" class="clear" title="'+langData['siteConfig'][6][162]+'"><s></s></a><span class="tip-inline"></span></dd></dl>';
