					...
					if(list.length > 0){
						for(var i = 0; i < list.length; i++){
					  	...
					  	html.push('</tr>');
							...
							html.push('<span>'+langData['siteConfig'][18][75]+'：'+(list[i].idcardFront != '' ? '<a href="'+list[i].idcardFront+'" target="_blank"><img src="'+list[i].idcardFront+'" /></a>' : '<em>'+langData['siteConfig'][45][76]+'</em>')+'</span>');//身份证正面 -- 未上传
							html.push('<span>'+langData['siteConfig'][18][76]+'：'+(list[i].idcardBack != '' ? '<a href="'+list[i].idcardBack+'" target="_blank"><img src="'+list[i].idcardBack+'" /></a>' : '<em>'+langData['siteConfig'][45][76]+'</em>')+'</span>');//身份证反面 -- 未上传
							html.push('<span>'+langData['siteConfig'][26][161]+'：'+(list[i].litpic != '' ? '<a href="'+list[i].litpic+'" target="_blank"><img src="'+list[i].litpic+'" /></a>' : '<em>'+langData['siteConfig'][45][76]+'</em>')+'</span>');//名片--未上传
							html.push('<span>'+langData['siteConfig'][20][602]+'：'+(list[i].license != '' ? '<a href="'+list[i].license+'" target="_blank"><img src="'+list[i].license+'" /></a>' : '<em>'+langData['siteConfig'][45][76]+'</em>')+'</span>');//执业资格认证--未上传
							html.push('</td>');
					  	html.push('</tr>');
					  	html.push('</tobdy>');
					  	html.push('</table>');
