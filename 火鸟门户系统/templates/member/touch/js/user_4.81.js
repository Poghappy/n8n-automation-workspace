						   ...
						   for(var i=0; i<list.length; i++){
							   if(type == 'tieba'){
								  ...
								  for(let m=0; m<((list[i].imgGroup.length>3)?3:(list[i].imgGroup.length));m++){
									  tiebaHtml.push('<div class="pro_img"><img data-url="'+list[i].imgGroup[m]+'" src="/static/images/blank.gif" alt=""></div>');
								  }
								  ...
								  tiebaHtml.push('</a></li>');
								   ...
								   bimgHtml.push('<img data-url="'+list[i].litpic+'"  src="/static/images/blank.gif" alt="">');
								   if(type == 'live' ){
								...
								if(i%2==1){
									flowHtml1.push('<li data-id="'+list[i].id+'" class="'+li_class+'"><a href="'+list[i].url+'">');
									flowHtml1.push('<div class="pro_img">');
									flowHtml1.push('<img data-url="'+list[i].litpic+'"  src="'+imgsrc+'" alt="">');
									...
									if(li_class=='video_li'){
									   ...
									   flowHtml1.push('<div class="sc_num"><i></i><em>'+list[i].zan+'</em></div></div>');
										...
										flowHtml1.push('<div class="pro_detail">'+price+'<div class="num_store '+(list[i].collect?"":"fn-hide")+'">'+langData['siteConfig'][13][14].replace("1",list[i].collect)+'</div></div>');  //1人收藏
									}

									flowHtml1.push('</div></a></li>');

								}else{
									flowHtml2.push('<li data-id="'+list[i].id+'" class="'+li_class+'"><a href="'+list[i].url+'">');
									flowHtml2.push('<div class="pro_img">');
									flowHtml2.push('<img data-url="'+list[i].litpic+'"  src="'+imgsrc+'" alt="">');
									...
									if(li_class=='video_li'){
									   ...
									   flowHtml2.push('<div class="sc_num"><i></i><em>'+list[i].zan+'</em></div></div>');
										...
										flowHtml2.push('<div class="pro_detail">'+price+'<div class="num_store '+(list[i].collect?"":"fn-hide")+'">'+langData['siteConfig'][13][14].replace("1",list[i].collect)+'</div></div>');  //1人收藏
									}
	                      ...
	                      list.push('</a>')
							...
							if (d.media.length == 2 || d.media.length == 4) {
								...
								for (var m = 0; m < d.media.length; m++) {
									list.push('<div class="img_item d_img"><img data-url=' + d.media[m] + ' src= src="/static/images/blank.gif"></div>');
								}
								list.push('</div>');
								...
								for (var l = 0; l < imglen; l++) {
									list.push('<div class="img_item m_img"><img data-url=' + d.media[l] + ' src="/static/images/blank.gif"></div>');
								}
								list.push('</div>');
								...
								list.push('<div class="img_item v_img"><img data-url=' + d.media[0] + '  src="/static/images/blank.gif"></div>')
								list.push('</div>');
