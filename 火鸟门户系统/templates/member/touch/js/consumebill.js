...
$(function(){
  ...
  var activeDate = currYear+'-'+currMonth;
	...
	function getMonthData(date){
		...
		$.ajax({
			url: "/include/ajax.php?service=member&action=bonusSummary",
			data: data.join('&'),
			type: "GET",
			dataType: "json",
...
function getList(is,date){
	...
	$.ajax({
		url: "/include/ajax.php?service=member&action=bonus",
		data: data.join('&'),
		type: "GET",
		dataType: "json",
		success: function (data) {
					...
					if(list.length > 0){
						...
						for(var i = 0; i < list.length; i++){
							...
							if(flag ==1){//月份已存在
                                ...
                                // if(type == '0'){
                                //   html2.push('<img src="'+templets_skin+'images/record/consume_xf.png" alt="">');
                                // }else if(typee == '2'){
                                //   html2.push('<img src="'+templets_skin+'images/record/xfmoney.png" alt="">');
                                // }else if(type == '1'){
                                //   html2.push('<img src="'+templets_skin+'images/record/tuihui.png" alt="">');
								// }
								...
								html2.push('<p class="time"><em>'+addDateInV1_2(dateA[0])+'</em>'+sf+'</p>');
								html2.push('</div>');
								html2.push('</div>');
								html2.push('</a>');
								html2.push('</dd>');
								...
								// if(type == '0'){
								// 	html.push('<img src="'+templets_skin+'images/record/consume_xf.png" alt="">');
								// }else if(type == '2'){
								// 	html.push('<img src="'+templets_skin+'images/record/xfmoney.png" alt="">');
								// }else if(type == '1'){
								// 	html.push('<img src="'+templets_skin+'images/record/tuihui.png" alt="">');
								// }
					            ...
					            var sfar = dateA[1].split(':');
					            var sf = sfar[0]+':'+sfar[1];
								html.push('<p class="time"><em>'+addDateInV1_2(dateA[0])+'</em>'+sf+'</p>');
								html.push('</div>');
								html.push('</div>');
								html.push('</a>');
								html.push('</dd>');
